class Vector {
    ...
    draw(origin, arrows, c) {
        ...
        line.lineTo(Vector.resolve(this).x * prop + origin.x, -Vector.resolve(this).y * prop + origin.y);
        canvas.stroke(line);
        ...
        if (arrows) {
            let arrowLeg = new Vector( (8/prop),  degrees(this.angle) + 140);
            arrowLeg.draw(
                {
                    x:Vector.resolve(this).x * prop + origin.x,
                    y:-Vector.resolve(this).y * prop + origin.y
            ...
            arrowLeg = new Vector( (8/prop),   degrees(this.angle) - 140);
            arrowLeg.draw(
                {
                    x:Vector.resolve(this).x * prop + origin.x,
                    y:-Vector.resolve(this).y * prop + origin.y
